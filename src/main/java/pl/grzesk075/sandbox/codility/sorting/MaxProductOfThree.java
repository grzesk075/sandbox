...
public class MaxProductOfThree {
    class Solution {
        public int solution(int[] A) {
            ...
            //countingSort(A, -1000, 1000);  // should be O(n), but Codility reports O(N * log(N))
        ...
        private void countingSort(final int[] array, final int minValue, final int maxValue) {
